package main.ms.recensioni.web.rest;
...
import main.ms.recensioni.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link main.ms.recensioni.domain.Recensione}.
 */
@RestController
...
public class RecensioneResource {
    ...
    private static final String ENTITY_NAME = "msRecensioniRecensione";
    ...
    public RecensioneResource(RecensioneService recensioneService, RecensioneRepository recensioneRepository) {
    ...
    public ResponseEntity<RecensioneDTO> createRecensione(@Valid @RequestBody RecensioneDTO recensioneDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/recensiones/" + recensioneDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, recensioneDTO.getId()))
            .body(recensioneDTO);
    }
    ...
    public ResponseEntity<RecensioneDTO> updateRecensione(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, recensioneDTO.getId()))
            .body(recensioneDTO);
    }
    ...
    public ResponseEntity<RecensioneDTO> partialUpdateRecensione(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, recensioneDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<RecensioneDTO> getRecensione(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteRecensione(@PathVariable("id") String id) {
