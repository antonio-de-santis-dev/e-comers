...
import { sampleWithRequiredData } from '../riga-ordine.test-samples';
...
describe('RigaOrdine Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.rigaOrdines()[0]).toEqual(expect.objectContaining({ id: 32109 }));
  });

  describe('trackId', () => {
    it('should forward to rigaOrdineService', () => {
      const entity = { id: 32109 };
      jest.spyOn(service, 'getRigaOrdineIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRigaOrdineIdentifier).toHaveBeenCalledWith(entity);
