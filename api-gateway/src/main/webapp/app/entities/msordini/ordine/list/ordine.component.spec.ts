...
import { sampleWithRequiredData } from '../ordine.test-samples';
...
describe('Ordine Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.ordines()[0]).toEqual(expect.objectContaining({ id: 15761 }));
  });

  describe('trackId', () => {
    it('should forward to ordineService', () => {
      const entity = { id: 15761 };
      jest.spyOn(service, 'getOrdineIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOrdineIdentifier).toHaveBeenCalledWith(entity);
