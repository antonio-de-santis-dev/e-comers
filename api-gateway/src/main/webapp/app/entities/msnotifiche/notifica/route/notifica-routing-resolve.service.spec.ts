...
import notificaResolve from './notifica-routing-resolve.service';

describe('Notifica routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: NotificaService;
  let resultNotifica: INotifica | null | undefined;
  ...
  describe('resolve', () => {
    it('should return INotifica returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        notificaResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultNotifica).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<INotifica>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
